/mob/living/carbon/human/examine()
	...
	if(stomach_contents.len)
		msg += "[t_He] [t_has] a large distended bulge in [t_his] stomach!\n"
	if(womb_contents.len || wombfull == 1)
		msg += "[t_He] appears to be heavily pregnant!\n"
	if(cock_contents.len || cockfull == 1)
		msg += "[t_He] appears to be have a large, swollen sack between [t_his] legs!\n"
	if(boob_contents.len || boobfull == 1)
		msg += "[t_He] has a massive pair of breasts!\n"
	msg += "</span>"
