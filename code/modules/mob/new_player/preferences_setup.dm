datum/preferences
	...
	proc/random_character(gender_override)
		...
		if(gender == FEMALE) facial_hair_style = "shaved"
	...
	proc/update_preview_icon()		//seriously. This is horrendous.
		...
		// Skin tone
		if (s_tinge >= 0)
			preview_icon.Blend(rgb(s_tinge, s_tinge, s_tinge), ICON_ADD)
		else
			preview_icon.Blend(rgb(-s_tinge,  -s_tinge,  -s_tinge), ICON_SUBTRACT)
